  ...
  public void handle(ResponseMessage message) throws Exception {
    if (message instanceof ChunkFetchSuccess) {
      ...
      if (listener == null) {
        ...
        long _fetchTime = System.currentTimeMillis() - resp.streamChunkId.timestamp;
        long _proceedTime = System.currentTimeMillis() - _startTime;
        logger.info("====For priority {}, streamId {}, index {}, size {}, fetch takes {} ms, proceed takes {} ms", resp.streamChunkId.priority, resp.streamChunkId.streamId, resp.streamChunkId.chunkIndex, resp.body().size(), _fetchTime, _proceedTime);
      }
