...
private[spark] class ZippedPartitionsPartition(
  ...
  override val pRddIndex: Array[Int] = rdds.map(rdd => rdd.id).toArray
  override val pRddPartitionIndex: Array[Int] = rdds.map(rdd => rdd.partitions(idx).index).toArray
  override val partitionId: Int = rdds.head.partitions(idx).index
