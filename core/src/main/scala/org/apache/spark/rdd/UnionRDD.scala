...
private[spark] class UnionPartition[T: ClassTag](
  ...
  override val partitionId: Int = parentPartition.index

  override val pRddIndex: Array[Int] = Array(rdd.id)

  override val pRddPartitionIndex: Array[Int] = Array(parentPartition.index)
