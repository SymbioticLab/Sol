...
private case class StatusUpdate(taskId: Long, state: TaskState, serializedData: ByteBuffer, core: String, ready: Int, waiting: Int)
...
private[spark] class LocalEndpoint(
  ...
  override def receive: PartialFunction[Any, Unit] = {
    ...
    case StatusUpdate(taskId, state, serializedData, core, ready, waiting) =>
...
private[spark] class LocalSchedulerBackend(
  ...
  override def statusUpdate(taskId: Long, state: TaskState, serializedData: ByteBuffer, core: String, ready: Int, waiting: Int) {
    localEndpoint.send(StatusUpdate(taskId, state, serializedData, core, ready, waiting))
  }
