...
private[spark] class ExternalSorter[K, V, C](
  ...
  private val testDeserialization = conf.getBoolean("spark.externalSort.disabled", false)

  private val testSpillable = conf.getBoolean("spark.spillable.disabled", false)
